<?php if($error = session()->get('error')): ?>
    <div class="alert alert-danger alert-dismissable">
        ...
        <h5><i class="icon fa fa-ban"></i><?php echo e(\Illuminate\Support\Arr::get($error->get('title'), 0), false); ?></h5>
...
<?php if($success = session()->get('success')): ?>
    <div class="alert alert-success alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h5><i class="icon fa fa-check"></i><?php echo e(\Illuminate\Support\Arr::get($success->get('title'), 0), false); ?></h5>
        <p><?php echo \Illuminate\Support\Arr::get($success->get('message'), 0); ?></p>
    </div>
<?php endif; ?>

<?php if($info = session()->get('info')): ?>
    <div class="alert alert-<?php echo "info";?> alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h5><i class="icon fa fa-info"></i><?php echo e(\Illuminate\Support\Arr::get($info->get('title'), 0), false); ?></h5>
...
<?php if($warning = session()->get('warning')): ?>
    <div class="alert alert-warning alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h5><i class="icon fa fa-warning"></i><?php echo e(\Illuminate\Support\Arr::get($warning->get('title'), 0), false); ?></h5>
        <p><?php echo \Illuminate\Support\Arr::get($warning->get('message'), 0); ?></p>
    </div>
<?php endif; ?>
<?php /**PATH D:\GhaimaStore\ghaima\vendor\encore\laravel-admin\src/../resources/views/partials/alerts.blade.php ENDPATH**/ ?>